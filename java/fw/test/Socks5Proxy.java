...
public class Socks5Proxy {
    ...
    public synchronized void start() {
        ...
        try {
            /*if (SmackConfiguration.getLocalSocks5ProxyPort() < 0) {
                ...
                this.serverSocket = new ServerSocket(1777);
            //}
    ...
    private class Socks5ServerProcess implements Runnable {
        ...
        private void establishConnection(Socket socket) throws IOException {
            ...
            int b = in.read();
            if (b != 5) {
                System.out.println("Only SOCKS5 supported");
            }
            ...
            if (!noAuthMethodFound) {
                ...
                out.flush();
                System.out.println("Authentication method not supported");
            }
            ...
            byte[] connectionRequest = Socks5Utils.receiveSocks5Message(in,responseDigest);

            // extract digest
            responseDigest = new String(connectionRequest, 5, connectionRequest[4]);

            System.out.println("Connect to: "+responseDigest);
