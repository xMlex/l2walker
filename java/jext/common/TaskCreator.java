...
public class TaskCreator {
	public static Runnable createTask(final Object obj, final Method method,
			final Object... args) {
		return new Runnable() {
			public void run() {
				try {
	...
	public static Runnable createTask(Object obj, Class<?> clazz,
	...
	public static Runnable createTask(Object obj, String className,
			String methodName, Object... args) throws SecurityException,
	...
	public static Runnable createTask(Class<?> clazz, String methodName,
			Object... args) throws SecurityException, NoSuchMethodException {
		return createTask(null, clazz, methodName, args);
	}

	public static Runnable createTask(String className, String methodName,
			Object... args) throws SecurityException, NoSuchMethodException,
	...
	public static Method getMethod(Class<?> clazz, String name,
		...
		for (Method method : clazz.getMethods()) {
			if (method.getName() == internedName
					&& paramsEq(paramTypes, method.getParameterTypes()))
				return method;
		}
