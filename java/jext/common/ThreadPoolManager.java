...
public class ThreadPoolManager {
	...
	private ThreadPoolManager() {
		_generalScheduledThreadPool = new ScheduledThreadPoolExecutor(2,
		...
		_generalPacketsThreadPool = new ThreadPoolExecutor(2,
				Integer.MAX_VALUE, 15L, TimeUnit.SECONDS,
				new SynchronousQueue<Runnable>(), new PriorityThreadFactory(
						"Normal Packet Pool", Thread.NORM_PRIORITY + 3));
	...
	public void shutdown() {
		...
		try {
			...
			if (_generalScheduledThreadPool != null)
				_generalScheduledThreadPool.awaitTermination(1,
						TimeUnit.SECONDS);
	...
	public static String getThreadPoolStats(ThreadPoolExecutor pool,
			String poolname) {
