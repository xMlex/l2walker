...
public class PrintfFormat {
	public static final PrintfFormat LOG_BOSS_KILLED = new PrintfFormat(
			"%s: %s[%d] killed by %s at Loc(%d %d %d) in %s");
	public static final PrintfFormat LOG_BOSS_RESPAWN = new PrintfFormat(
			"%s: %s[%d] scheduled for respawn in %s at %s");
	...
	private class ConversionSpecification {
		...
		/**
		 * Constructor<?> for a conversion specification. The argument must
		 * begin with a % and end with the conversion character for the
