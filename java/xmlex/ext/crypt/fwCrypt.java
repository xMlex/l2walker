package xmlex.ext.crypt;

import java.io.IOException;
import java.util.logging.Logger;

public class fwCrypt {
	...
	protected static Logger _log = Logger.getLogger(fwCrypt.class.getName());
	 ...
	 * @param blowfishKey
	 */
	public fwCrypt(byte[] blowfishKey) {
	 ...
	 * @param useStaticKey
	 */
	public fwCrypt(boolean staticKey) {
		_crypt = new BlowfishEngine();
	...
	public fwCrypt(String key) {
		this(key.getBytes());
	}

	public static boolean verifyChecksum(byte[] raw) {
		return fwCrypt.verifyChecksum(raw, 0, raw.length);
	}
	...
	public static void appendChecksum(byte[] raw) {
		fwCrypt.appendChecksum(raw, 0, raw.length);
	}
...
//	}
	...
	public static void encXORPass(byte[] raw, int key) {
		fwCrypt.encXORPass(raw, 0, raw.length, key);
	}
